...
title: system.kanoa.qds.config.sheets.addSheetAlertGroups
---
...
user_id = 123
records_created = system.kanoa.qds.config.sheets.addSheetAlertGroups(chkShtId=chk_sht_id, alertGroupIdList=alert_group_id_list, userId=user_id)
